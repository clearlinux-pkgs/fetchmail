...
Source0  : https://sourceforge.net/projects/fetchmail/files/branch_6.5/fetchmail-6.5.2.tar.xz
Source1  : https://sourceforge.net/projects/fetchmail/files/branch_6.5/fetchmail-6.5.2.tar.xz.asc
...
%setup -q -n fetchmail-6.5.2
cd %{_builddir}/fetchmail-6.5.2
pushd ..
cp -a fetchmail-6.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735572192
