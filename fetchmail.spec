...
Version  : 6.5.4
Release  : 45
URL      : https://sourceforge.net/projects/fetchmail/files/branch_6.5/fetchmail-6.5.4.tar.xz
Source0  : https://sourceforge.net/projects/fetchmail/files/branch_6.5/fetchmail-6.5.4.tar.xz
Source1  : https://sourceforge.net/projects/fetchmail/files/branch_6.5/fetchmail-6.5.4.tar.xz.asc
...
%setup -q -n fetchmail-6.5.4
cd %{_builddir}/fetchmail-6.5.4
pushd ..
cp -a fetchmail-6.5.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750255181
