...
Source0  : https://sourceforge.net/projects/fetchmail/files/branch_6.4/fetchmail-6.4.11.tar.xz
Source1  : https://sourceforge.net/projects/fetchmail/files/branch_6.4/fetchmail-6.4.11.tar.xz.asc
...
%prep
%setup -q -n fetchmail-6.4.11
cd %{_builddir}/fetchmail-6.4.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598635647
...
cp %{_builddir}/fetchmail-6.4.11/COPYING %{buildroot}/usr/share/package-licenses/fetchmail/96d8f76071f8618c2e59133bb8f08422cb8b4886
cp %{_builddir}/fetchmail-6.4.11/m4-local/ac-archive-license.txt %{buildroot}/usr/share/package-licenses/fetchmail/8534c1a6b8958dc54d9478b5195976bc3fb98f6a
%make_install
%find_lang fetchmail
