...
Source0  : https://sourceforge.net/projects/fetchmail/files/branch_6.4/fetchmail-6.4.32.tar.xz
Source1  : https://sourceforge.net/projects/fetchmail/files/branch_6.4/fetchmail-6.4.32.tar.xz.asc
...
%prep
%setup -q -n fetchmail-6.4.32
cd %{_builddir}/fetchmail-6.4.32
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659364476
