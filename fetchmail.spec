...
Source0  : https://sourceforge.net/projects/fetchmail/files/branch_6.4/fetchmail-6.4.37.tar.xz
Source1  : https://sourceforge.net/projects/fetchmail/files/branch_6.4/fetchmail-6.4.37.tar.xz.asc
...
%prep
%setup -q -n fetchmail-6.4.37
cd %{_builddir}/fetchmail-6.4.37
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677513752
