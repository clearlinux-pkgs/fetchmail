...
Source0  : https://sourceforge.net/projects/fetchmail/files/branch_6.4/fetchmail-6.4.38.tar.xz
Source1  : https://sourceforge.net/projects/fetchmail/files/branch_6.4/fetchmail-6.4.38.tar.xz.asc
...
%prep
%setup -q -n fetchmail-6.4.38
cd %{_builddir}/fetchmail-6.4.38
pushd ..
cp -a fetchmail-6.4.38 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706799295
